...
static inline void
assert_equal_vec4(msh_vec4_t v,
                  msh_scalar_t a,
                  msh_scalar_t b,
                  msh_scalar_t c,
                  msh_scalar_t d)
...
test_msh_vec_math_vector_convert(const MunitParameter params[], void* fixture)
{
  ...
  v4 = msh_vec2_to_vec4(v2, 5.0f, 6.0f);
  assert_equal_vec4(v4, 1.0, 2.0, 5.0, 6.0);

  v4 = msh_vec3_to_vec4(v3, 8.0f);
  assert_equal_vec4(v4, 1.0, 2.0, 3.0, 8.0);

  return MUNIT_OK;
}

MunitResult
test_msh_vec_math_vector_arithmetic(const MunitParameter params[],
                                    void* fixture)
{
  (void)fixture;
  (void)params;
